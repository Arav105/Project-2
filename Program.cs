        ...
        static void Main(string[] args)
        {
            ...
            switch (ss)
            {
                case 1:
                    ...
                    string textFile = "G:\\Project - 2\\Studentdata.txt";
                    ...
                    // Write to file
                    File.WriteAllLines("G:\\Project - 2\\SortByAge.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    // Write to file
                    File.WriteAllLines("G:\\Project - 2\\SortByName.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                ...
                case 2:
                    ...
                    string[] words = File.ReadAllText("G:\\Project - 2\\Studentdata.txt").Split(' ');
